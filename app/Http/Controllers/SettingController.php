...
class SettingController extends Controller
{
   ...
   function updateAppdata(Request $req)
   {
      ...
      DB::table('appdata')->where('id', 1)->update([
         ...
         'referral_diamond' => $req->referral_diamond,
         'first_friend' => $req->first_friend,
         'per_day_swipe_limit' => $req->per_day_swipe_limit,
         'previus_swipe_diamond' => $req->previus_swipe_diamond,
         'super_like_diamond' => $req->super_like_diamond,
         'first_message_diamond' => $req->first_message_diamond,
         'video_call_diamond' => $req->video_call_diamond
      ]);
   ...
   function change_language(Request $request)
   {
      $lang=Language::whereId($request->chang_lang)->first();
      if($lang){
         Session::put('lang_option',$lang->short_code);
