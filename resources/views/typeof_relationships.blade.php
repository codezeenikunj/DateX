...
@section('header')
    ...
    <script src="{{ asset('asset/script/relationship_type.js') }}"></script>
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <div class=" ">
                        ...
                        <h5>{{ __('add_relationship_type') }} </h5>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <a class="btn btn-primary relationship_typesaddModalbtn ml-auto" href="" data-toggle="modal"
                ...
                data-target="#addcat">{{ __('add_relationship_type') }}
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped w-100" id="relationship_typeTable">
        ...
        <div class="modal-dialog " role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('edit_relationship_type') }}</h5>
