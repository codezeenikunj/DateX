...
@section('header')
    ...
    <script src="{{ asset('asset/script/knowlanguage.js') }}"></script>
...
@section('content')
                    ...
                    <div class="">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="add_category"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="cat_title" name="language_name" class="form-control" required>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h4>{{ __('know_languages') }}</h4>

            <a class="btn btn-primary relationship_typesaddModalbtn ml-auto" href="" data-toggle="modal"

                data-target="#addcat">{{ __('add_know_languages') }}
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped w-100" id="know_languagesTable">
        ...
        <div class="modal-dialog " role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('edit_know_languages') }}</h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="edit_cat" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <label for="">{{ __('language_name') }}</label>

                            <input type="text" class="form-control" id="editlanguage_name" name="language_name" required>
                      ...
                      {{--   <div class="form-group">
                        ...
                        <select name="relationship_type_lang" class="form-control">
